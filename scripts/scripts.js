...
var App = {
	...
	errorCallback : function(error) {
		...
		alert('An error occurred while trying to get camera access (Your browser probably doesnt support getUserMedia() ): ');
		return;
	},
	...
	drawToCanvas : function(effect) {
		var video = App.video,
			...
			ctx.drawImage(video, 0, -150, 1000,700);
...
App.init = function() {
	...
	App.glasses.crossOrigin = 'anonymous';
	...
	// 	navigator.mediaDevices.getUserMedia(App.video)
